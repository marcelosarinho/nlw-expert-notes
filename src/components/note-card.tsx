    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="inset-0 bg-black/50 fixed">
          <Dialog.Content className="overflow-hidden inset-0 md:inset-auto md:left-1/2 md:top-1/2 fixed md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] w-full bg-slate-700 md:rounded-md flex flex-col outline-none">
