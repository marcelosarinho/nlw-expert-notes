    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="inset-0 bg-black/50 fixed">
          <Dialog.Content className="overflow-hidden left-1/2 top-1/2 fixed -translate-x-1/2 -translate-y-1/2 max-w-[640px] h-[60vh] w-full bg-slate-700 rounded-md flex flex-col outline-none">
